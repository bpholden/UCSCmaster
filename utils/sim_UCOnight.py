...
parser.add_option("-g","--googledex",dest="googledex",default=["Bstars_test","A004_PRobertson_test","A014_SVogt_test"])
...
print ("sun rose")
fn = "observed_targets"
ParseUCOSched.update_local_googledex(curtime,googledex_file=os.path.join(outdir,options.infile), observed_file=os.path.join(outdir,fn))
