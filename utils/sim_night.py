...
parser.add_option("-g","--googledex",dest="googledex",default="Bstars,A000_BWelsh_2019B,A001_ICzekala_2019B,A002_ICzekala_2019B,A003_PRobertson_2019B,A004_PRobertson_2019B,A006_PDalba_2019B,A008_BHolden_2019B,A009_MKosiarek_2019B,A011_SKane_2019B,A012_SKane_2019B,A015_AHoward_2019B,A013_ASiemion_2019B,A014_SVogt_2019B,A015_TBrandt_2019B")
...
print ("sun rose")
fn = "observed_targets"
ParseUCOSched.updateLocalGoogledex(curtime,outfn=os.path.join(outdir,options.infile), observed_file=os.path.join(outdir,fn))
